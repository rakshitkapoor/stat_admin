...
class ScheduleCardBronze extends StatefulWidget {
  const ScheduleCardBronze({super.key, required this.schedule});
  final schedule;

  @override
  State<ScheduleCardBronze> createState() => _ScheduleCardBronzeState();
}

class _ScheduleCardBronzeState extends State<ScheduleCardBronze> {
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(100, 176, 141, 87),
            boxShadow: [
              BoxShadow(
                blurRadius: 3.0,
